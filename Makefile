# This Makefile is for the RT::OnlineDocs extension to perl.
#
...
#     ABSTRACT => q[RT OnlineDocs Extension]
#     AUTHOR => q[Jesse Vincent <jesse@bestpractical.com>]
#     DIR => []
#     DISTNAME => q[RT-OnlineDocs]
#     INSTALLSITELIB => q[/opt/rt/rt3.fsck.com//local/lib]
#     NAME => q[RT::OnlineDocs]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Pod::Simple::HTML=>q[0] }
#     VERSION => q[0.01_02]
...
INSTALLSITELIB = /opt/rt/rt3.fsck.com//local/lib
DESTINSTALLSITELIB = $(DESTDIR)$(INSTALLSITELIB)
INSTALLVENDORLIB = $(VENDORPREFIX)/share/perl5
DESTINSTALLVENDORLIB = $(DESTDIR)$(INSTALLVENDORLIB)
INSTALLARCHLIB = $(PERLPREFIX)/lib/perl/5.8
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /usr/local/lib/perl/5.8.3
...
TO_INST_PM = lib/RT/OnlineDocs.pm

PM_TO_BLIB = lib/RT/OnlineDocs.pm \
	blib/lib/RT/OnlineDocs.pm
...
DISTNAME = RT-OnlineDocs
DISTVNAME = RT-OnlineDocs-0.01_02
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(MAKEFILE_OLD) $(FIRST_MAKEFILE) blib/lib/RT/OnlineDocs.pm
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>RT OnlineDocs Extension</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Jesse Vincent &lt;jesse@bestpractical.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Pod-Simple-HTML" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/RT/OnlineDocs.pm blib/lib/RT/OnlineDocs.pm 
	$(NOECHO) $(TOUCH) $@
...
install ::
	$(NOECHO) $(PERL) -MExtUtils::Install -e "install({q(html), q(/opt/rt/rt3.fsck.com//share/html)})"
